...
if __name__ == '__main__':
    ...
    default_ref = """
ありがとうございます。保険代理店ベネフィットでございます。お世話になります。AJテクノロジーズのツジと申します。はい、お世話になります。お世話になります。すいません、今なんですけれども、代表のおのだ様いらっしゃいますでしょうかえっと、ちょっと出かけておりますね。あ、ありがとうございましたか。承知いたしました。今って携帯とかにかけても問題ないですかねえーっと、ちょっと分かんないですね、その辺は。承知いたしました。じゃあまた、あのー、改めてご連絡差し上げます。はい、すいません、よろしくどうぞお願いします。すいません、お忙しいところありがとうございます。ども失礼いたします。
"""
    default_hyp = """
ありがとうございます。保険代理店ベネフィットでございます。お世話になります。A.J.テクノロジーズの藤井と申します。はい、お世話になります。お世話になります。すみません、今なんですけれども、代表のおもだ様いらっしゃいますでしょうか。えっとちょっと出かけておりますね。あ、ありがとうございました。はい。今って携帯とかにかけても問題ないですかね。えっと、ちょっと分かんないですねその絵は。承知いたしました。
はいではまたあの改めてご連絡申し上げますはいすいませんよろしくどうぞお疲れですいませんお忙しいところありがとうございます失礼します。
はい。
"""
    if len(sys.argv) >= 3:
